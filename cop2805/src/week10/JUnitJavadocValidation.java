...
public class JUnitJavadocValidation
{
	public JUnitJavadocValidation()
	{
		...
		methods1.add(new MethodTestData("city",0,"String","public"));
		...
		testFiles.add(new FileTestData("week10", "NFLEnumeration.java", methods1,
				constructors1));

		m_validator = new JUnitJavadocValidationUtility("Week10 Javadoc Test",
				testFiles);
